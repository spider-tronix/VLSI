...
reg dummy;
/*----Initial value----*/
FloatingMultiplication M1(.A({{1'b0,8'd126,B[22:0]}}),.B(32'h3ff0f0f1), .result(temp1), .enable(enable)); //verified
...
/*----First Iteration----*/
FloatingMultiplication M2(.A({{1'b0,8'd126,B[22:0]}}),.B(x0), .result(temp2), .enable(enable));
FloatingAddition A2(.subract_A(0), .subract_B(0), .A(32'h40000000),.B({!temp2[31],temp2[30:0]}),.result(temp3), .enable(enable));
FloatingMultiplication M3(.A(x0),.B(temp3), .result(x1), .enable(enable));

/*----Second Iteration----*/
FloatingMultiplication M4(.A({1'b0,8'd126,B[22:0]}),.B(x1), .result(temp4), .enable(enable));
FloatingAddition A3(.subract_A(0), .subract_B(0), .A(32'h40000000),.B({!temp4[31],temp4[30:0]}),.result(temp5), .enable(enable));
FloatingMultiplication M5(.A(x1),.B(temp5), .result(x2), .enable(enable));

/*----Third Iteration----*/
FloatingMultiplication M6(.A({1'b0,8'd126,B[22:0]}),.B(x2), .result(temp6), .enable(enable));
FloatingAddition A4(.subract_A(0), .subract_B(0), .A(32'h40000000),.B({!temp6[31],temp6[30:0]}),.result(temp7), .enable(enable));
FloatingMultiplication M7(.A(x2),.B(temp7), .result(x3), .enable(enable));
...
FloatingMultiplication M8(.A(A),.B(reciprocal), .result(result), .enable(enable));
endmodule
