...
/*----First Iteration----*/
FloatingDivision D1(.enable(enable), .A({1'b0,8'd126,Mantissa}),.B(x0),.result(temp1));
FloatingAddition A1(.enable(enable), .subract_A(0), .subract_B(0),.A(temp1),.B(x0),.result(temp2));
assign x1 = {temp2[31],temp2[30:23]-1,temp2[22:0]};
/*----Second Iteration----*/
FloatingDivision D2(.enable(enable),.A({1'b0,8'd126,Mantissa}),.B(x1),.result(temp3));
FloatingAddition A2(.enable(enable),.subract_A(0), .subract_B(0),.A(temp3),.B(x1),.result(temp4));
assign x2 = {temp4[31],temp4[30:23]-1,temp4[22:0]};
/*----Third Iteration----*/
FloatingDivision D3(.enable(enable),.A({1'b0,8'd126,Mantissa}),.B(x2),.result(temp5));
FloatingAddition A3(.enable(enable),.subract_A(0), .subract_B(0), .A(temp5),.B(x2),.result(temp6));
assign x3 = {temp6[31],temp6[30:23]-1,temp6[22:0]};
FloatingMultiplication M1(.enable(enable),.A(x3),.B(sqrt_1by05),.result(temp7));
...
FloatingMultiplication M2(.enable(enable), .A(temp),.B(sqrt_2),.result(temp8));
